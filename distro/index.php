...
?>
    ...
    <div class="row">
      ...
      <?php 
        $queryBanner = "SELECT * FROM banner WHERE aktif='1' ORDER BY id_banner DESC LIMIT 3";
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
          <?php 
            if($id_kategori){
              $queryBarang = mysqli_query($koneksi, "SELECT * FROM barang WHERE aktif='1' AND id_kategori = '$id_kategori' ORDER BY rand() DESC LIMIT 9");
            }elseif($search){
              //query barang
              $queryBarang = mysqli_query($koneksi, "SELECT * FROM barang WHERE aktif='1' AND nama_barang LIKE '%$search%' ORDER BY rand() DESC LIMIT 9");
            }
            else{
              $queryBarang = mysqli_query($koneksi, "SELECT * FROM barang WHERE aktif='1' ORDER BY rand() DESC LIMIT 9");
            } 
         ?>
          ...
          ?>            
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                <a href="item.php?id_barang=<?= $id_barang; ?>"><img class="card-img-top" src="<?= $gambar; ?>" alt="" width="100px"></a>
